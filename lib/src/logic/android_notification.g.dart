...
FirebaseAndroidNotification _$FirebaseAndroidNotificationFromJson(
  ...
  lightSettings: json['light_settings'] == null
      ? null
      : LightSettings.fromJson(json['light_settings'] as Map<String, dynamic>),
  proxy: $enumDecodeNullable(_$AndroidNotificationProxyEnumMap, json['proxy']),
);
