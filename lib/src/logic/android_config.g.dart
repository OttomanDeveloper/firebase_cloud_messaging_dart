...
FirebaseAndroidConfig _$FirebaseAndroidConfigFromJson(
  ...
  priority: $enumDecodeNullable(
    _$AndroidMessagePriorityEnumMap,
    json['priority'],
  ),
  ...
  fcmOptions: json['fcm_options'] == null
      ? null
      : AndroidFcmOptions.fromJson(json['fcm_options'] as Map<String, dynamic>),
...
AndroidFcmOptions _$AndroidFcmOptionsFromJson(Map<String, dynamic> json) =>
    AndroidFcmOptions(analyticsLabel: json['analytics_label'] as String?);
